//! `GET /api/conflict/v1/ucdp-events` — pure reader for the UCDP
//! GED feed (T4.5.1).
...
mod tests {
    use super::*;
    use crate::conflict::v1::UCDP_EVENTS_PATH;
    use axum::body::Body;
    ...
    async fn migrated() -> (axum::Router, pellucid_db::Pool) {
        ...
        let app = axum::Router::new()
            .route(UCDP_EVENTS_PATH, axum::routing::get(handler).with_state(state));
        (app, pool)
    }
