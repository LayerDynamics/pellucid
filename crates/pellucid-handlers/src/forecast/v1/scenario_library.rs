//! `GET /api/forecast/v1/scenario-library` — pure reader of
//! the SLOW scenario-library slot.
...
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct ScenarioLibraryResponse {
...
pub async fn handler(
...
) -> Result<Json<ScenarioLibraryResponse>, HandlerError> {
    ...
    Ok(Json(ScenarioLibraryResponse {
        rows: snap.rows,
        total,
...
mod tests {
    use super::*;
    use crate::forecast::v1::SCENARIO_LIBRARY_PATH;
    use axum::body::Body;
